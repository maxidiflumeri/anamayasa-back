    ...
    generaArchivo: async (queryParams) => {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                let direcciones = await connection.query(queryDirecciones)
                let vinculos = await connection.query(queryVinculos)
                let facturas = await connection.query(queryFacturas)
                let pagos = await connection.query(queryPagos)
                let comentarios = await connection.query(queryComentarios)
                let convenios = await connection.query(queryConvenios)
