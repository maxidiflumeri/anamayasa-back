...
class p_codigos_situacionController {
  ...
  async obtenerPorIdEmpresa(req, res, next) {
    try {
      const response = await _connection.default.query(`select * from v_codigos_situacion where id_empresa =${req.query.id_empresa} order by descripcion ASC`, {
...
var _default = p_codigos_situacionController;
